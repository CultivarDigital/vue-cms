<template>
  <div class="address-form">
    <table v-if="value && value.length" class="table b-table">
      <tbody>
        <tr v-for="(organizer, index) in value" :key="index">
    ...
    <b-btn variant="success" @click="show_modal = !show_modal"><client-only><b-icon-plus /></client-only> Adicionar organizador</b-btn>
    <b-modal v-model="show_modal" title="Adicionar organizador" hide-footer size="lg">
